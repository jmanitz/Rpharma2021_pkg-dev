...
So many reasons! From sharing code and collaboration, to reproducibility and regulatory concerns, and finally for organizing you own analysis projects and tidy coding practices, R packages are here to help!
...
- <img src="media/twitter.png", width="25px", align="left">@exuberantleigh  
...
4. What do you want use package development for? 
  - Personal use, 
...
* Use wrapper functions to create same plots across scripts/RMarkdown files
    ...
    + move seemlessly from html, to Word, to Powerpoint
...
---
class: inverse
# Workshop Part II: Outline / Basic R package components:
...
---
class: inverse
# Outline / Basic R package components: 
...
- `R/` directory contains all R codehmm 
...
---
# Toy Example: OOP Classes

- How to find out the class?
- how to define class?
...
---
# Toy Example: OOP Methods

- example print for numeric from plusone(x)
- define  `print.math <- function() ...`
- `print.math` is differnet from `print.numeric`
...
---
# Toy Example: OOP Documentation


Toy example or real-world example 
